...
if AZURE_STORAGE_CONNECTION_STRING:
    try:
        ...
        print("⚠️ Make sure AZURE_STORAGE_CONNECTION_STRING is set in .env file")
else:
    print("⚠️ AZURE_STORAGE_CONNECTION_STRING not found in environment variables")
    print("⚠️ Video upload and streaming features will not work")
